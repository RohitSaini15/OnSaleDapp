...
class Shop_accessories extends Component {
    constructor(props){
      super(props);
      this.state={
        text: [],
    ...
    render() {
      ...
      <h2 style={{marginBottom: "30px"}}>ACCESSORIES'S</h2>
          ...
          <div className="product-card" key={item.id.toString()}>
            ...
            <div className="product-card1">
              ...
              onClick={async () => {
                              ...
                              try{
                                await this.props.addToCart(item.id.toString(),this.state.quantity_selected[item.id],"accesories")
  ...
  export default Shop_accessories;